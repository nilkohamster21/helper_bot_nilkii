...
#     text_blocks=[
#     "Дикий кабан: характеристики и особенности",
#     "Дикий кабан обладает грубой шерстью, достигает 1 метра в холке и ведет стайный образ жизни.",
#     "Дикий кабан имеет острые клыки, не агрессивный, но опасен в период размножения.",
#     "Дикий кабан отличается от домашней свиньи по строению тела и поведению.",
#     "Шерсть кабана более грубая и образует гриву, окрас зависит от среды обитания.",
#     "Дикий кабан играет важную роль в поддержании баланса экосистемы."
# ]
#
#
#     ,
